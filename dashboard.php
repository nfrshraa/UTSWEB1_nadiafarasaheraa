...
// Catatan: Array $barangList telah DIHAPUS. 
// Semua data (Nama, Harga) harus diinput manual oleh pengguna.

// Inisialisasi variabel untuk menampung input yang gagal atau berhasil divalidasi
